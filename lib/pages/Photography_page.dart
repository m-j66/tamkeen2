import 'package:tamkeen2/Data_Json/Photography._json.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "DISCOVER", style: TextStyle(fontSize: 16)
                      ...
                      children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage(
                                      Photography_usersList[index]['img'] ??
                                          ''),
                                  fit: BoxFit.cover,
                                ),
                              ),
                        ...
                        Flexible(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Photography_usersList[index]['name'] ?? '',
                                style: GoogleFonts.pacifico(fontSize: 19),
                              ),
                              Text(
                                Photography_usersList[index]['bio'] ?? '',
                                style: TextStyle(
                                  fontSize: 15,
