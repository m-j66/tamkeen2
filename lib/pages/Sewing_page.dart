import 'package:tamkeen2/Data_Json/Sewing_json.dart';
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Sewing_usersList[index]['name'] ?? '',
                                style: GoogleFonts.pacifico(fontSize: 19),
                              ),
                              Text(
                                Sewing_usersList[index]['bio'] ?? '',
                                style: TextStyle(
                                  fontSize: 15,
